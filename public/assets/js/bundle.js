...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body{\n    background: rgb(255, 255, 255);\n    min-height: 100vh;\n}", "",{"version":3,"sources":["webpack://./frontend/assets/css/style.css"],"names":[],"mappings":"AAAA;IACI,8BAA8B;IAC9B,iBAAiB;AACrB","sourcesContent":["body{\n    background: rgb(255, 255, 255);\n    min-height: 100vh;\n}"],"sourceRoot":""}]);
// Exports
...
var b = 'oid';
console.log(b);
fetch('https://api.tibiadata.com/v3/character/klasjjx').then(function (e) {
